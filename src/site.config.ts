...
const config: SiteConfig = {
  ...
  title: 'Alexis LOUBIERE',
  // The description of your site, used for SEO and RSS feed.
  description:
    'My personal site containing my devlogs and ctf writeups',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Alexis LOUBIERE',
  // Keywords for SEO, used in the meta tags.
  tags: ['Astro', 'Terminal', 'Theme', 'MultiTerm', 'Mkps', 'aloubier'],
  ...
  socialLinks: {
    ...
    linkedin: 'www.linkedin.com/in/alexis-loubiere-07790916b',
  ...
  giscus: {
    repo: 'Mkps/site-perso',
    repoId: 'R_kgDOQfMLRg',
    category: 'Giscus',
    lang: 'fr',
    categoryId: 'DIC_kwDOQfMLRs4CzLo_',
